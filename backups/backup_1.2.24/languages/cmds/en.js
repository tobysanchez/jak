module.exports = {
	...
	rules: {
		...
		longDescription: "أضف/قائمة/عدل/إحذف قوانين مجموعتك ✓",
		guide: "   قوانين [أضف/إحذف/قائمة/عدل] <أكتب قانون>: لكي تضيف قانون للمجموعة أو تحذفه أو ترى القائمة.\n   مثلا /قوانين أضف ممنوع السب 😐"
	},
	sendnoti: {
