...
module.exports = {
	...
	langs: {
		...
		en: {
			missingUrl: "الرجاء إدخال الرابط الخاص بالفيديو من الفيسبوك لتنزيله",
			error: "حدث خطأ أثناء تنزيل الفيديو",
			downloading: "جاري تحميل الفيديوا",
			tooLarge: "عذرًا ، لا يمكننا تنزيل الفيديو لك لأن الحجم أكبر من 83 ميغا بايت"
		}
	},
