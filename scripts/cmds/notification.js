...
module.exports = {
	config: {
		...
		shortDescription: {
			...
			en: "أمر خاص بآدمن البوت مالك دخل 😐"
		},
		longDescription: {
			vi: "Gửi thông báo từ admin đến all box",
	...
	langs: {
		...
		en: {
			missingMessage: "الرجاء إدخال الرسالة التي تريد إرسالها إلى كافة المجموعات",
			notification: "إشعار من أدمن البوت 🍷🌚",
			sendingNotification: "بدأ في ارسال إشعار من آدمن البوت الى %1 مجموعة",
			sentNotification: "✅ تم إرسال الإشعار الى المجموعات",
