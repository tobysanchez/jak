...
module.exports = {
	...
	langs: {
		...
		en: {
			charts: "🏆 | تصنيف:\n%1",
			pageInfo: "صفحة %1/%2",
			noScore: "⭕ | لا يوجد أحد مسجل.",
			noPermissionReset: "⚠️ | ليس لديك إذن لإعادة الترتيب.",
			notFoundUser: "⚠️ | تعذر العثور على مستخدم بالمعرف %1 في الترتيب.",
			userRankInfo: "🏆 | تصنيف معلومات:\nالإسم: %1\nالنتيجة: %2\nعدد الألعاب: %3\nعدد الانتصارات: %4\n%5\nعدد الخسائر: %6\nمعدل الفوز: %7%\nإجمالي وقت اللعب: %8",
			digits: "%1 digits: %2",
			resetRankSuccess: "✅ | أعد تعيين الترتيب بنجاح.",
			invalidCol: "⚠️ | الرجاء إدخال عدد أرقام الرقم المراد تخمينه هو 4 أو 5 أو 6",
			invalidMode: "⚠️ | الرجاء إدخال وضع اللعبة أحادي أو متعدد",
			created: "✅ | إنشاء اللعبة بنجاح.",
			gameName: "GUESS NUMBER GAME",
			gameGuide: "⏳ | كيف تلعب:\nلديك %1 تخمينات.\nبعد كل تخمين ، ستحصل على تلميحات إضافية لعدد الأرقام الصحيحة (كما هو موضح على اليسار) وعدد الأرقام الصحيحة (كما هو موضح على اليمين).",
			gameNote: "📄 | ملحوضة:\nيتكون الرقم من أرقام من 0 إلى 9 ، ويظهر كل رقم مرة واحدة فقط ويمكن أن يبدأ الرقم بـ 0.",
			replyToPlayGame: "🎮 | الرد على الصورة أدناه بي %1 أرقام التي تخمنها لتلعب اللعبة.",
			invalidNumbers: "⚠️ | تفضل %1 الأرقام التي تريد تخمينها",
			win: "🎉 | مبروك لقد خمنت الرقم %1 بعد %2 التخمينات واستلامها %3 نقاط المكافأة.",
